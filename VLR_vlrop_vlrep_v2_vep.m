...
function [EVIvlrop_he,EVIvlrop_zf,total_vlrop_exi1,vlrop_exi ,PPvlrop, EVIvlrop_exi]=VLR_vlrop_vlrep_v2_vep(out,Speech_Rate)
% 
fs=8000;
...
[EVIvlrop_he]= vlropHEoflpresidual_v1(he1,fs,Gd_flipped,Speech_Rate);

%%%%------------------------------ %%From zerofrequency filtered output
[ EVIvlrop_zf,zffo, gclocssp1]= vlropZerofrequency_v1(out,winlength,fs,Gd_flipped,Speech_Rate);

% [EVIvlrop_zf,zpzbf, epoc]=vlropZPZBF(out,winlength,fs,Gd_flipped,Speech_Rate);
